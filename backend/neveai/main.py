...
from neveai.utils.actions import chat_action as chat_action_handler
from neveai.utils.embeddings import generate_embeddings
...
from neveai.utils.plugin import install_tool_and_function_dependencies
...
if ENABLE_OTEL:
    from neveai.utils.telemetry.setup import setup as setup_opentelemetry
...
app.state.config.WEB_SEARCH_ENGINE = "duckduckgo"  # Force DuckDuckGo
